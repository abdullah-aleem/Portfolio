...
export default function Services() {
  ...
  return (
    <div className='flex container mx-auto mt-20 w-2/4 border-2 border-gray-300 rounded-3xl mb-10' >
      <div className='flex flex-col border-3  border-gray-200  ml-10 items-centen Relative pt-5 pb-5'>
        <div className='flex flex-col'>
          <h1 className='ml-2 text-6xl text-black'>Abdullah <span className='text-6xl text-gray-500'>Aleem</span> </h1>


        </div>
        <h1 className='ml-4 text-5xl mt-10 text-gray-400'>Services</h1>
        <div className='flex flex-col mt-2  flex ml-4  relative  pl-2 border-gray-500 border-l-2 border-rounded-xl '>
          ...
          <h2 className='text-4xl text-gray-600'>Web development</h2>
        
      <ul className="grid grid-cols-2 gap-2 w-40">
        <li className="flex items-center">
          <span className="mr-2">&#8226;</span> MERN
        </li>
        <li className="flex items-center">
        ...
        <li className="flex items-center">
          ...
          <div className='flex flex-row'>
            <img className='w-10  h-10 mr-1' src={html} />
            <img className='w-10  h-10 mr-1' src={js} />
            <img className='w-10  h-10 mr-1' src={react} />
            <img className='w-10  h-10 mr-1' src={node} />
            <img className='w-10  h-10 mr-1' src={mongo} />
            <img className='w-10  h-10 mr-1' src={mysql} />
          </div>
        </div>
        <div className=' flex flex-col ml-4 relative  pl-2 border-gray-500 border-l-2 border-rounded-xl'>
          <div className='mt-6'>
            <div className='rounded-xl w-3 h-3 bg-gray-500 absolute -left-1.5 mt-2.5'></div>
            <h2 className='text-4xl text-gray-600 '>Android development</h2>
            <ul className="grid grid-cols-2 gap-2 w-40">
        <li className="flex items-center">
        ...
        <li className="flex items-center">
          <span className="mr-2">&#8226;</span> Firebase
            ...
            <div className='flex flex-row'>
              <img className='w-10  h-10 mr-1' src={flutter} />
              <img className='w-10  h-10 mr-1' src={java} />
              <img className='w-10  h-10 mr-1' src={react} />
              <img className='w-10  h-10 mr-1' src={andriod} />
              <img className='w-10  h-10 mr-1' src={ios} />
        ...
        <div className='flex flex-col ml-4 relative  pl-2 border-gray-500 border-l-2 border-rounded-xl'>
          <div className='mt-5'>
            <div className='rounded-xl w-3 h-3 bg-gray-500 absolute -left-1.5 mt-2.5'></div>
            <h2 className='text-4xl text-gray-600'>Automation/Scripting</h2>
            <ul className="grid grid-cols-2 gap-2 w-40">
        <li className="flex items-center">
        ...
        <li className="flex items-center">
          <span className="mr-2">&#8226;</span> C
            ...
            <div className='flex flex-row'>
              <img className='w-10  h-10 mr-1' src={python} />
              <img className='w-10  h-10 mr-1' src={jupyter} />
              <img className='w-10  h-10 mr-1' src={anaconda} />
            </div>
          </div>
        </div>
        <h1 className='ml-4 text-5xl mt-10 text-gray-400'>Work</h1>
        <div className='flex flex-col mt-2  flex ml-4  relative  pl-2 border-gray-500 border-l-2 border-rounded-xl '>
